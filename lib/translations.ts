...
export const TRANSLATIONS: Record<string, Record<string, any>> = {
  en: {
    ...
    monthly: "✦ Monthly — €12.99 / month", yearly: "✦ Yearly — €129 / year",
  ...
  pl: {
    ...
    monthly: "✦ Miesięcznie — €12.99 / miesiąc", yearly: "✦ Rocznie — €129 / rok",
  ...
  ja: {
    ...
    monthly: "✦ 月額 — €12.99 / 月", yearly: "✦ 年額 — €129 / 年",
  ...
  ko: {
    ...
    monthly: "✦ 월간 — €12.99 / 월", yearly: "✦ 연간 — €129 / 년",
  ...
  zh: {
    ...
    monthly: "✦ 月度 — €12.99 / 月", yearly: "✦ 年度 — €129 / 年",
  ...
  hi: {
    ...
    monthly: "✦ मासिक — €12.99 / माह", yearly: "✦ वार्षिक — €129 / वर्ष",
